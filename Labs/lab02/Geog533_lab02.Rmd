...
library(DT)
datatable(df.USA,options = list(pageLength = 5,scrollX=TRUE),caption = "USA")
datatable(df.nonUSA,options = list(pageLength = 5,scrollX=TRUE),caption = "non-USA")
```
...
str(USA.csv)
library(DT)
datatable(USA.csv,options = list(pageLength = 5, scrollX=TRUE),caption = "USA")
```
